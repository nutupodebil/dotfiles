...
hl.animation({ leaf = "windowsIn",     enabled = true, speed = 3,    bezier = "easeOutQuint", style = "slide bottom" })
hl.animation({ leaf = "windowsOut",    enabled = true, speed = 1.75, bezier = "linear",       style = "slide" })
...
hl.animation({ leaf = "layersOut",     enabled = true, speed = 1,    bezier = "linear",       style = "popin" })
